...
<div class="bg-white rounded-xl p-6 shadow-sm mb-6">
  ...
  <div class="flex items-center gap-2 mb-4">
    <input
      ...
      readonly
      class="flex-1 px-4 py-3 bg-[#F5F5F5] rounded-xl text-sm font-mono"
    />
    <button
      onclick={copyLink}
      class="px-4 py-3 bg-[#6B9B7A] text-white rounded-xl text-sm hover:bg-[#5A8A69]"
    >
