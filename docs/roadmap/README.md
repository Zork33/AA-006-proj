...
| 4 | ~~Реферальная система не работает~~ | Готово (Фаза 1.5) |
| 5 | ~~Дедупликация неполная~~ | Готово (Фаза 1.5) |
| 6 | ~~Нет согласия 152-ФЗ~~ | Готово (Фаза 1.5) |
| 7 | ~~Email — заглушка~~ | Готово (Фаза 1.5) |
| 8 | ~~Seed не использует ROOT_ADMIN_EMAIL~~ | Готово (Фаза 1.5) |
| 9 | ~~Нет эндпоинтов admin/services~~ | Готово (Фаза 1.5) |
| 10 | ~~Фронтенд без API~~ | Готово (Фаза 1.5) |
| 11 | ~~Guard не проверяет роли~~ | Готово (Фаза 1.5) |
| 12 | ~~Нет Swagger~~ | Готово (Фаза 1.5) |
| 13 | ~~Инфраструктура~~ | Готово (Фаза 1.5) |
| 14 | ~~Нет интеграционных тестов~~ | Готово (Фаза 1.5) |
...
| 5 | ~~Закрыть критические пробелы (Фаза 1.5)~~ | Готово |
