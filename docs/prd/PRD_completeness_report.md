...
> Связанные документы: [PRD](README.md) | [Промпт для UI](../ui-prompts/README.md) | [Архитектура](../architecture/README.md) | [Инфраструктура](../infrastructure/README.md) | [План развития](../roadmap/README.md) | [BDD](../bdd/README.md)
