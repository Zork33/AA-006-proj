...
> Связанные документы: [PRD](../prd/README.md) | [Отчёт по полноте PRD](../prd/PRD_completeness_report.md) | [Промпт для UI](../ui-prompts/README.md) | [Инфраструктура](../infrastructure/README.md)
